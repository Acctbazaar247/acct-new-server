...
router.get('/', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.seller, client_1.UserRole.superAdmin, client_1.UserRole.user), orders_controller_1.OrdersController.getAllOrders);
...
router.get('/:id', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.superAdmin, client_1.UserRole.user, client_1.UserRole.seller), orders_controller_1.OrdersController.getSingleOrders);
