...
exports.fetchBankCodes = exports.initiateWithdrawal = void 0;
...
const initiateWithdrawal = ({ tx, account_bank, account_number, amount, narration = 'Withdrawal transaction', // Default narration if none is provided
    ...
    try {
        ...
        const account_bank_code = (_a = allBanks.find(bank => bank.bank_name.toLocaleLowerCase() === account_bank.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.bank_code;
