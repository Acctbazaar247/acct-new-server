...
router.post('/verify-signup-token', (0, validateRequest_1.default)(auth_validation_1.AuthValidation.verifyToken), (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.superAdmin, client_1.UserRole.seller, client_1.UserRole.user), auth_controller_1.AuthController.verifySignupToken);
router.post('/resend/:email', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.superAdmin, client_1.UserRole.seller, client_1.UserRole.user), auth_controller_1.AuthController.resendEmail);
